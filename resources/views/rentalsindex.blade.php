...
<div class="container-fluid px-4">
    ...
    <div class="" style="align-items: center;direction:rtl;">
        <div class="col-md-12">
            <h4 class="" class="" style="text-align:center;margin-right:200px;">إضافةفاتورة <i class="fa fa-plus" style="font-size:32px;margin-right: 15px;" onclick="showModel()"></i></h4>
